  ...
  return (
    <section id="about">
      <Container className="flex flex-col px-6 items-center">
        ...
        <div data-aos='fade-up' className="flex flex-col items-center justify-center min-w-full space-y-14 space-x-0 md:flex-row md:space-y-0 md:space-x-16">
          <div className={`${classes["about-me"]} md:w-1/2`}>
            <div className={classes.content}>
              ...
              <a href={MyResume} download={MyResume}><button>See more</button></a>
            </div>
          </div>
